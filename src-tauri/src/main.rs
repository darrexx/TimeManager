...
use timer::{run_timer, timer_handler, TimerCommand, Timer};

use commands::{start_timer, stop_timer, reset_timer};
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            thread::spawn(move || {
                timer_handler(&app_handle, command_receiver, tick_receiver, timer_sender, u)
            });
